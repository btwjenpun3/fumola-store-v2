                            ...
                            <div id="payment-process" style="display: none;">
                                <div class="mb-4 flex w-full max-w-xs justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        ...
                                        <circle cx="50" cy="50" fill="none" stroke="#85a2b6"
                                ...
                                <h5 class="text-2xl font-bold text-white">Proses.....
                                </h5>
                            </div>
    ...
    <script>
        ...
        window.Echo.channel('topup-{{ $data->nomor_invoice }}')
            .listen('TopUpEvent', (event) => {
                ...
                var removePaymentInfo = document.getElementById('payment-info');
                removePaymentInfo.style.display = 'none';

                var showProcess = document.getElementById('payment-process');
                showProcess.style.display = 'block';
                showProcess.classList.add('animate-bounce');
            });

        window.Echo.channel('topup-success-{{ $data->nomor_invoice }}')
            .listen('TopUpSuccess', (event) => {
                Toastify({
                    text: event.message,
                    close: true,
                    gravity: "top",
                ...
                var showPaymentInfo = document.getElementById('payment-success');
                showPaymentInfo.style.display = 'block';
                showPaymentInfo.classList.add('animate-bounce');

                var removeProcess = document.getElementById('payment-process');
                removeProcess.style.display = 'none';
                removeProcess.classList.add('animate-bounce');
            });
    </script>
@endsection
